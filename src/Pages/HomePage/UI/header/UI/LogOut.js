...
const LogOut = () => {
    ...
    return (
        <div className="logout-wrapper" onClick={e => {
            dispatch(logOut)
        }}>
            <p className="logout-wrapper__title">Выйти</p>
            <svg  className="logout-wrapper__svg" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.8">
                    <path
